...
7. **suggestions**: Actionable, prioritized recommendations for next steps (array)
8. **metrics**: Object with totalCommits, totalRepos, primaryLanguages (array), codeQualityTrend ("improving" | "stable" | "needs-attention"), productivityScore (1-10)
...
The JSON must include all required fields: date, title, narrative, highlights, repoSummaries, crossRepoPatterns, technicalThemes, suggestions, metrics.
</formatting>`;
}
